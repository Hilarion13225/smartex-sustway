  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[90rem] px-4 pb-8 pt-6 text-center sm:px-5 sm:pb-12 sm:pt-8">
        {/* Sur grand écran : emblème animé à gauche, discours et actions à
            droite ; en dessous de lg les deux blocs s'empilent. */}
        <div className="lg:grid lg:grid-cols-[minmax(0,1.05fr)_minmax(0,1fr)] lg:items-center lg:gap-12 lg:text-left">
          ...
          <div className="relative mx-auto aspect-[640/420] w-full max-w-xs motion-safe:animate-apparition-douce sm:max-w-xl lg:max-w-none">
          ...
          <div>
            <h1
              className="mx-auto mt-4 max-w-4xl text-[1.65rem] font-bold leading-[1.15] text-ink-900 motion-safe:animate-apparition-bas sm:text-4xl lg:mx-0 lg:mt-0 lg:max-w-none lg:text-[1.45rem] lg:leading-[1.3] xl:text-[1.7rem]"
              style={{ animationDelay: '120ms' }}
            >
              Avec <span className="text-[#2e9e4b] dark:text-[#5fbd72]">SMARTEX SustWay</span>, évaluer et optimiser la
              démarche de maturité et la performance de votre entreprise en matière de bonnes pratiques de{' '}
              <span className="text-[#2e9e4b] dark:text-[#5fbd72]">RSE et ESG</span> en s’appuyant sur l’IA.
              Indépendance, Robustesse et Transparence de la Solution.
            </h1>
          ...
          évaluer, prioriser et améliorer votre performance RSE et ESG.
            ...
            >
              {/* « la solution » désigne la page que la navigation publique
                  intitule « Solution », c'est-à-dire /services. La méthodologie
                  a son propre lien dans le menu. */}
              <Link
                to="/services"
