...
export default function EnTeteVitrine({ etiquette, icone, titre, description, image, reperes }) {
  ...
  return (
    <section className="relative overflow-hidden border-b border-ink-100">
      ...
      />
      <span
        className="pointer-events-none absolute -right-20 -top-16 h-72 w-72 rounded-full bg-brand-200/40 blur-3xl motion-safe:animate-respiration dark:bg-brand-500/20"
        aria-hidden
      />
